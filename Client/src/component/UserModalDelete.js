...
const Modaldelete = (props) => {
  ...
  if (props.type == "delete") {
    ...
    axios.delete(`http://localhost:5000/staff/delete/${props.profile._id}`)
    .then(() => {
      ...
      axios.delete(`http://localhost:5000/student/delete/${props.profile._id}`)
    .then(() => {
      swal("Deleted!", "Successfully Deleted", "success");
        navigate("/UserLogin");
      }).catch((err) => {
      ...
      axios.delete(`http://localhost:5000/Admin/delete/${props.profile._id}`)
    .then(() => {
      swal("Deleted!", "Successfully Deleted", "success");
        navigate("/UserLogin");
      }).catch((err) => {
