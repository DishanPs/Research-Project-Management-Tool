...
const SubTypes = ({upd}) => {
  ...
  const [SubmissionType, setType] = useState(upd != null ? (upd.SubmissionType) : (''));
        ...
        <Modal.Body>
          <Form noValidate validated={validated}>
            ...
            <Form.Group className="mb-3">
                ...
                <Form.Select value={SubmissionType} onChange={(e) => setType(e.target.value)} required>
            ...
            <Form.Group className="mb-3">
                ...
                <Form.Control type="date" placeholder="Date"
                  ...
                  required />
                <Form.Control.Feedback type="invalid">Enter Date</Form.Control.Feedback>
            </Form.Group>
            ...
            <Form.Group className="mb-3">
                ...
                <Form.Control type="time" placeholder="Time" 
                  ...
                  required />
                <Form.Control.Feedback type="invalid">Enter Time</Form.Control.Feedback>
            </Form.Group>
          </Form>
        </Modal.Body>
